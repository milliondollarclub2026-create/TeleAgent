        ...
        <div className="max-w-6xl mx-auto px-6 md:px-12 relative">
          ...
          <div className="relative scroll-reveal" style={{ transitionDelay: '100ms' }}>
            ...
            <div className="hidden lg:block absolute top-[4.5rem] left-[calc(16.666%+1rem)] right-[calc(16.666%+1rem)] z-0">
              ...
              {/* Connection nodes */}
              <div className="absolute -top-[5px] left-[-37px] w-3 h-3 bg-emerald-500 rounded-full shadow-lg shadow-emerald-500/40 step-node step-node-1" />
              ...
              <div className="absolute -top-[5px] right-[-37px] w-3 h-3 bg-emerald-500 rounded-full shadow-lg shadow-emerald-500/40 step-node step-node-3" />
            </div>
