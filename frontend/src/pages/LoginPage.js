...
const LoginPage = () => {
  ...
  const GradientPanel = () => (
    <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-white border-r border-slate-100">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[50%] pointer-events-none z-[1]" style={{ background: 'linear-gradient(to top, #e2e8f0 0%, rgba(226,232,240,0.3) 40%, transparent 100%)' }} />
  ...
  return (
    <div className="min-h-screen flex bg-white relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative">
        {/* Bottom gradient fade */}
        <div className="absolute bottom-0 left-0 right-0 h-[50%] pointer-events-none z-0" style={{ background: 'linear-gradient(to top, #e2e8f0 0%, rgba(226,232,240,0.2) 40%, transparent 100%)' }} />
