  ...
  return (
    <div className="min-h-screen flex bg-white relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative">
        {/* Bottom gradient fade */}
        <div className="absolute bottom-0 left-0 right-0 h-[50%] pointer-events-none z-0" style={{ background: 'linear-gradient(to top, rgba(5,150,105,0.06) 0%, rgba(5,150,105,0.02) 40%, transparent 100%)' }} />
